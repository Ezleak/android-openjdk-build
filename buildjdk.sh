...
export CFLAGS+="-mllvm -polly-vectorizer=slp -mllvm -polly-memory -mllvm -polly-opt-parallelize-parallel -mllvm -polly-opt-outer-loops" # Polly extra
