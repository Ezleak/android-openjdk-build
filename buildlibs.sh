...
export LDFLAGS+=" -fuse-ld=lld -Wl,-plugin-opt=-emulated-tls=0 -Wl,--strip-all -fvisibility=hidden -Wl,-Bsymbolic -Wl,-Ofast -Wl,--sort-common -Wl,--relax -Wl,--gc-sections -Wl,--as-needed -Wl,--lto-Ofast -Wl,-plugin-opt=-emulated-tls=0"
export LDFLAGS+=" -flto=thin -Ofast -fopenmp -l:libomp.a"
